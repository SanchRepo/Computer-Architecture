...
HD_PWD='C:/Users/szh24/Desktop/Pre lab/bit_reversal_reg/bit_reversal_reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_resversal_reg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_resversal_reg.tcl -notrace
