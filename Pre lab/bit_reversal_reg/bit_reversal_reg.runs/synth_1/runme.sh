...
HD_PWD='C:/Users/szh24/Desktop/Pre lab/bit_reversal_reg/bit_reversal_reg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_resversal_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_resversal_reg.tcl
