...
#set_property PACKAGE_PIN U14 [get_ports {rx[0]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {rx[0]}]
#set_property PACKAGE_PIN V14 [get_ports {rx[1]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {rx[1]}]
#set_property PACKAGE_PIN V13 [get_ports {rx[2]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {rx[2]}]
#set_property PACKAGE_PIN V3 [get_ports {ry[0]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {ry[0]}]
#set_property PACKAGE_PIN W3 [get_ports {ry[1]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {ry[1]}]
#set_property PACKAGE_PIN U3 [get_ports {ry[2]}]
