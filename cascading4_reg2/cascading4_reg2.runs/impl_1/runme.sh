...
HD_PWD='C:/Users/szh24/Desktop/xilinx_projects/cascading4_reg2/cascading4_reg2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cascading4_reg2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cascading4_reg2.tcl -notrace
