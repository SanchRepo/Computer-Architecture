...
HD_PWD='C:/Users/szh24/Desktop/xilinx_projects/cascading4_reg2/cascading4_reg2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cascading4_reg2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cascading4_reg2.tcl
